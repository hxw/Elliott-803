...
static ssize_t read_file(const char *file_name, io5_mode_t mode, void *data,
                         size_t data_size) {
...
static size_t raw_write_file(const char *file_name, const void *buffer,
                             size_t buffer_size) {
...
#
  ...
  rc = check_data(actual, actual_size, lines_expected,
